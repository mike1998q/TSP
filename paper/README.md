...
- **Figure 1**: colour-coded "three empirical gaps → three structural
  remedies" schematic (TikZ, self-contained in main.tex).
- **Figure 2**: colour-coded, layered architecture diagram — teal
...
- **Figure 3**: module-internals diagram (R2-style) of the two
...
- **Figure 4** (`fig_evidence.pdf`): dual-domain evidence, generated by
...
The reference list was expanded from 16 to 28 entries (Transformer,
linear/MLP, frequency, SSM, and decomposition families), and the prose was

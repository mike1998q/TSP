...
accurate. The optional dispersion head adds a fixed $13$K parameters shared
across variates ($0.07\%$ on Traffic). Wall-clock figures are left for the
extended version.
...
head's full four-variant chain, with the residual-stationarity battery, is
reported in the extended version. The fixed 96-step look-back hides long
cycles that the multi-resolution dispersion statistics begin to address.
